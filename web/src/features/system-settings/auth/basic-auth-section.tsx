...
const basicAuthSchema = z.object({
  ...
  InvitationRegisterEnabled: z.boolean(),
    ...
    <SettingsSection title={t('Basic Authentication')}>
      <Form {...form}>
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <FormField
            control={form.control}
            name='InvitationRegisterEnabled'
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  <FormLabel>{t('Invitation Registration')}</FormLabel>
                  <FormDescription>
                    {t('Require an invitation code for new user registration')}
                  </FormDescription>
                </SettingsSwitchContent>
                <FormControl>
                  <Switch
